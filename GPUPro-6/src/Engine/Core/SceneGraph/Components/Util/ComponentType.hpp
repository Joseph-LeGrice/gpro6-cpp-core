...
//
//template<class T, ComponentTypeID id, class InitFunctor>
//struct ComponentRegistrationInfo
//{
//    static const ComponentTypeID sc_componentId = id;
...
//
//template<class X, ComponentTypeID Y, class InitFunctor>
...
//
//template<class X, ComponentTypeID Y, class InitFunctor, class... T>
